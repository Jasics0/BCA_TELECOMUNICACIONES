...
public class ticketsActivos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Historico.",
                "A1. Modificaciones acordadas.", "A2. Publicidad engañosa.", "A3. Servicios no solicitados.",
                "A4. Fraude de contratación.", "A5. Datos personales.", "A6. Plan Corporativo.",
                "B1. Imposibilidad terminacion de contrato.", "B2. Clausula de permanencia sin consentimiento.",
                "B3. Clausula de permanencia superior a un año.", "B4. Valor subsidiado o financiado.",
                "B5. Falta de información.", "B6. Portabilidad númerica.", "B7. Cambio pospago a prepago.",
                "C1. Activación sin autorización.", "C2. Falta de información.", "C3. No controles de consumo.",
                "C4. Facturación.", "C5. Calidad del servicio.", "D1. No disponibilidad del servicio." }));
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addGap(302, 302, 302)
                        ...
                        jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                jPanel2Layout.createSequentialGroup().addGap(387, 387, 387)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tipo = jComboBox2.getSelectedItem().toString().charAt(0) + ""
                + jComboBox2.getSelectedItem().toString().charAt(1);
        if (jDateChooser1.getDate() != null && jDateChooser2.getDate() != null) {
            if (tipo.equals("Hi")) {
                jLabel3.setText(tdao.contarTicketsEntreFechas(jDateChooser1.getDate(),jDateChooser2.getDate())+"");
